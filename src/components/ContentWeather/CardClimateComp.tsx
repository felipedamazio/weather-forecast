...
export const CardClimateData = () => {
  ...
  return (
    <div className="card w-[100%] flex flex-col gap-4  relative p-6 bg-gradient-to-tl from-[#A9C9FF]  to-[#FFF3C7] shadow-xl rounded-lg transition-transform duration-500 ease-in-out transform hover:scale-105 cursor-pointer">
